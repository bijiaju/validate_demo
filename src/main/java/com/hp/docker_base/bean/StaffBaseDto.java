...
public class StaffBaseDto implements Serializable {
    ...
    @NotEmpty(message = "员工编号为空", groups = MiniValidation.class)
    ...
    @NotBlank(message = "员工姓名不能为空",groups = MiniValidation.class)
    private String name;

    @ApiModelProperty(value = "员工性别", example = "1:男 | 2:女")
    @Max(value = 2, message = "性别错误",groups = MiniValidation.class)
    @Min(value = 1, message = "性别错误",groups = MiniValidation.class)
    ...
    @NotEmpty(message = "身份证号为空", groups = MiniValidation.class)
    private String idNumber;

    @ApiModelProperty(value = "照片地址")
    @URL(message = "url格式错误", groups = MiniValidation.class)
    ...
    @Length(min = 2, max = 18, message = "职位长度为2-18个字符", groups = {MiniValidation.class, NewValidation.class})//多个组的校验
    private String postName;

    @ApiModelProperty(value = "员工在职状态", example = "1:在职 | 2:离职")
    @Max(value = 2, message = "在职状态错误",groups = MiniValidation.class)
    @Min(value = 1, message = "在职状态错误",groups = MiniValidation.class)
